...
data class Propiedad(
    ...
    @SerializedName("alberca")
    val alberca: Boolean,

    @SerializedName("sotano")
    val sotano: Boolean,

    @SerializedName("terraza")
    val terraza: Boolean,

    @SerializedName("cuartoServicio")
    val cuartoServicio: Boolean,

    @SerializedName("muebles")
    val muebles: Boolean,
    ...
    @SerializedName("publicadoEcommerce")
